...
//	概要	:	生成
//*********************************************************************************
CPhongShader* CPhongShader::Create(LPCTSTR pFxName , int nType , UINT unTech)
{
	CPhongShader* pShade = new CPhongShader();
...
//	概要	:	カメラセット
//*********************************************************************************
void CPhongShader::SetCamera(LPD3DXVECTOR3 pCamera , LPD3DXMATRIX pView , LPD3DXMATRIX pProj)
{
	m_vCamera = *pCamera;
	m_mView = *pView;
	m_mProj = *pProj;
...
//	概要	:	光源セット
//*********************************************************************************
void CPhongShader::SetLight(LPD3DXVECTOR3 pLight)
{
	m_vLight = *pLight;
}
...
//	概要	:	ワールド座標セット
//*********************************************************************************
void CPhongShader::SetWorldMatrix(LPD3DXMATRIX pWorld)
{
...
//	概要	:	マテリアルセット
//*********************************************************************************
void CPhongShader::SetMaterial(D3DMATERIAL9* pMaterial , LPDIRECT3DTEXTURE9 pTexture)
{
