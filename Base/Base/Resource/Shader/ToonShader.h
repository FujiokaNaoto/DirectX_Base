...
protected:
	...
	// トゥーンで持つハンドル
	D3DXHANDLE	m_hMeshRadius;	// テクスチャ有無
...
public:
	...
	static CToonShader*	Create(LPCTSTR pFxName , int nType , UINT unTech);
	...
	virtual void		SetMeshRadius(float fRadius);
};
//=================================================================================
