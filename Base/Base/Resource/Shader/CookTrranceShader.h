...
//==クラス・構造体宣言部===========================================================
class CCookTrranceShader : public CShader
{
protected:
...
public:
	CCookTrranceShader();
	virtual	~CCookTrranceShader();
	
	static CCookTrranceShader*	Create(LPCTSTR pFxName , int nType , UINT unTech);
