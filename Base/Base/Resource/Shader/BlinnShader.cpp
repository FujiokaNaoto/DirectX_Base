...
//	概要	:	生成
//*********************************************************************************
CBlinnShader* CBlinnShader::Create(LPCTSTR pFxName , int nType , UINT unTech)
{
	CBlinnShader* pShade = new CBlinnShader();
...
//	概要	:	初期化
//*********************************************************************************
bool CBlinnShader::Init(LPCTSTR pFxName , int nType , UINT unTech)
{
	m_nType = nType;
...
//	概要	:	カメラセット
//*********************************************************************************
void CBlinnShader::SetCamera(LPD3DXVECTOR3 pCamera , LPD3DXMATRIX pView , LPD3DXMATRIX pProj)
{
	m_vCamera = *pCamera;
	m_mView = *pView;
	m_mProj = *pProj;
...
//	概要	:	光源セット
//*********************************************************************************
void CBlinnShader::SetLight(LPD3DXVECTOR3 pLight)
{
	m_vLight = *pLight;
}
...
//	概要	:	ワールド座標セット
//*********************************************************************************
void CBlinnShader::SetWorldMatrix(LPD3DXMATRIX pWorld)
{
...
//	概要	:	マテリアルセット
//*********************************************************************************
void CBlinnShader::SetMaterial(D3DMATERIAL9* pMaterial , LPDIRECT3DTEXTURE9 pTexture)
{
